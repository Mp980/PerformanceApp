...
class GTracking(AnchorLayout, GridLayout):
    ...
    root = ScrollView(size_hint=(1, 0.8), pos_hint={'x': 0, 'y': 0.2})
...
class Record(GTracking):
    #Layout
    Layout = FloatLayout(size_hint_y= None, pos_hint={"x": 0.1, "y":0.1})
    PreviousSessionLayout = GridLayout(cols=2, size_hint=(None, None), width=330, pos_hint={"x": 0.1, "y": 0.01})
    #Calander
    CalanderButtonLoad = Button(text="Date?", size_hint=(0.3, 0.7), pos_hint = {"x": 0.1, "top":0.1})
